...
.. note::
   ...
   WikiMason preserves Markdown-like structure internally, but Logseq's
   visual editor may render nested tables and fenced code blocks
   differently. Prefer small, simple blocks in Logseq-authored pages.
