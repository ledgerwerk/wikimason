...
- Changed ledgercore integration to 0.6.x APIs while preserving WikiMason data contracts
- Documented the Markdown and MyST Sphinx documentation set with updated navigation, references, and validation
- Changed package metadata to use ledgerwerk GitHub project URLs
